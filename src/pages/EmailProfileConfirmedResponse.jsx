...
import { getSenderDataFromURLID, getConfirmMutualInterestFromURLID } from "../constant/url";

export const EmailProfileConfirmedResponse = (props) => {
    ...
    const handleProfileConfirmation = async(uqURL) => {
        ...
        await axios({
          method: "post",
          url: getConfirmMutualInterestFromURLID,
          data: bodyFormData,
          headers: { "Content-Type": "multipart/form-data" },
        })
          .then(function (response) {
                        ...
                        <div className="col-12 col-md-6">
                            <div className="card">
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-12 col-md-6">
                                            <img src={formData.photo} className="img-fluid" />
                                        </div>
                                        <div className="col">
                                            <p>{formData.fname}</p>
                                    ...
                                    <div className="col-12">
                                        ...
                                        <>
                                            <div className="">
                                                ...
                                                <p className="text-center">You have confirmed your interest. Their phone number has been sent to you via SMS, and vice versa.</p>
                                            </div>
                                        </>
                                        }
                                    </div>
